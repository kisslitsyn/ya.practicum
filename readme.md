...
#### [12. Прогнозы и предсказания. Прогнозирование оттока и кластеризация посетителей фитнес-центра](https://github.com/kisslitsyn/ya.praktikum/blob/master/12_gym.ipynb)

###### Описание: 
Сеть фитнес-центров «Культурист-датасаентист» разрабатывает стратегию взаимодействия с посетителями на основе данных. Задача — провести анализ клиентских анкет и подготовить план действий по удержанию клиентов. А именно:

- используя алгоритмы МО, cпрогнозировать вероятность оттока (на уровне следующего месяца) для каждого клиента;
...
<table width="100%" >
    ...
    <tr>
     <td align="left" >
       <ul> 
         <li> выбор модели для предсказания оттока клиентов </li> 
         <li> настройка гиперпараметров модели и расчет метрик </li>
         <li> кластеризация клиентов и анализ отдельных кластеров </li> 
       </ul> 
      </td> 
     <td valign="top" align="left" >  
       <ul> 
...
#### [13. Выпускной проект. Анализ эффективности торговых точек сети](https://github.com/kisslitsyn/ya.praktikum/blob/master/13_retail_efficiency.ipynb)
...
<table width="100%" >
    ...
    <tr>
     <td align="left" >
       <ul> 
         <li> декомпозиция задачи </li> 
         <li> проверка гипотез, сравнение лояльных и нелояльных клиентов </li>
         <li> выбор и расчет метрики для оценки эффективности торговой точки  </li> 
       </ul> 
      </td> 
     <td valign="top" align="left" >  
       <ul> 
...
[13. Выпускной проект. Обработка результатов A/B-теста](https://github.com/kisslitsyn/ya.praktikum/blob/master/13_ab.ipynb)
