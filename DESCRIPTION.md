...
###### Основные пункты:
- абота с несколькими источниками
- олучение данных из БД с использованием SQL запросов и подзапросов
- ормулирование и проверка гипотез статистическими методами
...
###### Основные пункты:
- Приоритизация гипотез (фреймворки ICE, RICE)
